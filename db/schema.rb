...
ActiveRecord::Schema.define(version: 2020_07_16_041232) do
  ...
  create_table "order_sweets", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order_id"], name: "index_order_sweets_on_order_id"
    t.index ["sweet_id"], name: "index_order_sweets_on_sweet_id"
  end
